...
ss = [State(i) for i in range(N + 1)] + [State(25)]
...
if __name__ == "__main__":
    ...
    simulation = Simulator(spec)
    res = simulation.simulate(1000)
    print(list(zip(spec.__states, res)))
