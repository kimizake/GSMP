...
if __name__ == "__main__":
    ...
    tq1 = GsmpComposition(q1, q2, synchros=[
        [('com', q1), ('arr', q2)],
        # [('com', q2), ('arr', q3)],
        # [('com', q3), ('arr', q4)]
    ])
    ...
    sim = Simulator(tq1)
    res = sim.simulate(epochs)

    sim2 = Simulator(tq2)
    res = sim2.simulate(epochs)
    ...
    print_plots(x, y1, 'Queue 1 composition')
    print_plots(x, y2, 'Queue 2 composition')
    ...
    print_plots(x, y3, 'Queue 1 normal')
    print_plots(x, y4, 'Queue 2 normal')
